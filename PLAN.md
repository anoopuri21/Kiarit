...
| 7 | **CEO's Message** | Ivory bg, large gold quote mark, portrait in gold arch frame with subtle grain, generic message paragraph, signature line: **Yogesh Kumar Bhatra — Founder & CEO** | Portrait scale-in, quote text word-by-word fade |
...
| CEO photo — Yogesh Kumar Bhatra | ⏳ Pending |
